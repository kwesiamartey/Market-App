...
import com.lornamobileappsdev.my_marketplace.databinding.FragmentUploadedProductSuccessfullyBinding
import com.lornamobileappsdev.my_marketplace.viewModels.PullingDataFromServerViewModel
import kotlin.reflect.jvm.jvmName


class UploadedProductSuccessfullyFragment : Fragment() {

    lateinit var _bind:FragmentUploadedProductSuccessfullyBinding
    val bind get() = _bind
    ...
    override fun onCreateView(
        ...
        _bind = FragmentUploadedProductSuccessfullyBinding.inflate(layoutInflater)
        ...
        bind.btnRLogin.setOnClickListener {
         ...
         viewModelClass.uploadProductText.observe(viewLifecycleOwner, Observer {
             bind.textView23.text = it
         })
